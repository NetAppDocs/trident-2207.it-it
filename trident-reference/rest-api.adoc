...
[role="lead"]
Mentre link:tridentctl.html["comandi e opzioni tridentctl"^] È il modo più semplice per interagire con l'API REST di Astra Trident, puoi utilizzare l'endpoint REST direttamente se preferisci.
