...
. Avviare Astra Trident utilizzando il sistema di plugin gestito.
+
[listing]
----
...
Un file di unità di esempio per i sistemi basati su sistema è disponibile all'indirizzo `contrib/trident.service.example` Nel Git repo. Per utilizzare il file con CentOS 7/RHEL, procedere come segue:
